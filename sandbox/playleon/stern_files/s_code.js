...
s.linkInternalFilters="javascript:,stern.de,stern-verlag.de,sternabnehmcoach.de,stern-abnehm-coach.de,stern.astrologen24.de,stern.arztauskunft.de,stern.autoanzeigen.de,stern.liga-liveticker.de,stern.stellenanzeigen.de,www.personalmarkt.de/stern/,www.placement24.com/microsite/stern/,www.puzzlecompany.de/production/public_puzzles/puzzles,tippspiel.stern.de,stern.parship.de,augenzeuge.stern.de,shortlist.stern.de,tippspiel.stern.de,download.stern.de,img2.stern.de,mobile.stern.de,stern.experteer.de,micro.co2online.de/index.php?portal_id=stern"
s.linkLeaveQueryString=false;
s.linkTrackVars="None";
s.linkTrackEvents="None";
s.usePlugins=true; // aktivieren
s.doPlugins=s_doPlugins; // benennen
...
s.visitorNamespace="guj";
s.dc="122";


/*============================================================*/
/*===== Site spezifisch start ================================*/
/*============================================================*/
/* 
code bitte "normalerweise in ./cmtools.js
hier nur "zur Note" code einbauen.
*/

/*============================================================*/
/*===== Site spezifisch ende =================================*/
/*============================================================*/
