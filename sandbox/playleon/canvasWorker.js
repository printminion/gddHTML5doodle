var canvasWorker = function () {
    ...
    this.people[0] = {
        ...
        dynmapId:'01', 
        picUrl: 'germanPeople/aeinstein.jpg', 
    ...
    this.people[1] = {
        ...
        dynmapId:'02', 
        picUrl: 'germanPeople/konradroentgen.jpg', 
    ...
    this.people[2] = {
        name: 'Konrad Zuse',
        dynmapId:'03', 
        picUrl: 'germanPeople/konradzuse.jpg', 
    ...
    this.people[3] = {
        name: 'Philip Reis',
        dynmapId:'04', 
        picUrl: 'germanPeople/philipreis.jpg', 
    ...
    this.people[4] = {
        name: 'Heinrich Hertz',
        dynmapId:'05', 
        picUrl: 'germanPeople/heinrichhertz.jpg', 
    ...
    this.people[5] = {
        ...
        dynmapId:'06', 
        picUrl: 'germanPeople/johannesgutenberg.jpg', 
    ...
    this.people[6] = {
        ...
        dynmapId:'07', 
        picUrl: 'germanPeople/wilhelmvonbayern.jpg', 
    ...
    this.people[7] = {
        ...
        dynmapId:'08', 
        picUrl: 'germanPeople/Lmeyer.jpg', 
    ...
    this.people[8] = {
        ...
        dynmapId:'09', 
        picUrl: 'germanPeople/karlheinzbrandenburg.jpg', 
    ...
    this.people[9] = {
        ...
        dynmapId:'10', 
        picUrl: 'germanPeople/gottliebdaimler.jpg', 
    ...
    this.people[10] = {
        name: 'Karl Benz',
        dynmapId:'16', 
        picUrl: 'germanPeople/ottohahn.jpg', 
    ...
    this.people[11] = {
        name: 'Melitta Bentz',
        dynmapId:'17', 
        picUrl: 'germanPeople/melittabentz.jpg', 
    ...
    this.people[12] = {
        name: 'Felix Hoffmann',
        dynmapId:'18', 
        picUrl: 'germanPeople/felixhoffmann.jpg', 
    ...
    this.people[13] = {
        name: 'Hans von Ohain',
        dynmapId:'19', 
        picUrl: 'germanPeople/hansvonohain.jpg', 
    ...
    this.people[14] = {
        name: 'Robert Koch',
        dynmapId:'20', 
        picUrl: 'germanPeople/robertkoch.jpg', 
    ...
    this.people[15] = {
        name: 'Artur Fischer',
        dynmapId:'21', 
        picUrl: 'germanPeople/arturfischer.jpg', 
    ...
    this.people[17] = {
        name: 'Emil Berner',
        dynmapId:'23', 
        picUrl: 'germanPeople/emilberner.jpg', 
    ...
    this.people[18] = {
        name: 'Martin Luther',
        dynmapId:'24', 
        picUrl: 'germanPeople/martinluther.jpeg', 
    ...
    this.people[19] = {
        ...
        dynmapId:'25', 
        picUrl: 'germanPeople/ottovonguerick.jpg', 
...
canvasWorker.prototype.printPeople = function() {
    ...
    if(this.currentPeopleIndex < this.people.length) {
         console.log(this.currentPeopleIndex,this.people[this.currentPeopleIndex]);
        ...
        canvasObj
        window.setTimeout("canvasObj.printPeople()", 3000);
    }
    /*
